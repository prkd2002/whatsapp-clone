...
import com.thm.whatsappclone.response.StringResponse;
import com.thm.whatsappclone.services.ChatService;
...
@Tag(name = "Chat Controller", description = "Operations pertaining to chats")
